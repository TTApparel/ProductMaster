...
- 2026-04-29: Product Loop element ordering now uses jQuery UI sortable with a drag handle for reliable reordering, and the “Card elements” heading is shown above the sortable list.
